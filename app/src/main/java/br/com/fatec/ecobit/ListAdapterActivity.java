...
public class ListAdapterActivity extends ArrayAdapter <String> {
    ...
    public ListAdapterActivity(Activity context, String[] mainTitle, String[] subTitle, int[] imagensArray) {
        super(context, R.layout.activity_lista_item, mainTitle);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.activity_lista_item, null, true);
